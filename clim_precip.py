...
for tile in tiles:
    ...
    if os.path.exists(out_path):
        print(f"Precipitation tile for {tile_str} exists. Skipping.")
    else:
        print(f"Processing precipitation tile for {tile_str}...")
        ...
        # )
        da = load_era5_variable(
            ERA5_ZARR_URL, variable, tile, 1995, 2026, daily_sum=True
        )
        print(da)
        da = da.chunk(
...
ds.to_netcdf(
    "resources/automatic/tp/era5_total_precipitation_year_average_1995_2025.nc",
    mode="w",
)
